...
public class EtudiantController extends HttpServlet {
    ...
    public void init() throws ServletException{
        ...
        dao = new EtudiantDAOImplementation ();
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     Etudiant etu1 = new Etudiant(id, name);
     ...
     dao.create(etu1);
        ...
        request.setAttribute("lstEtudiants", listeEtudiants);
         getServletContext().getRequestDispatcher("/ListeEtudiant.jsp").
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("lstEtudiants", listeEtudiants);
         ...
         request.setAttribute("x", etu);
         getServletContext().getRequestDispatcher("/Etudiant.jsp").
                forward(request, response);
